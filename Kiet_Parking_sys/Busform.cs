...
namespace Kiet_Parking_sys
{
    public partial class Busform : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
           ...
           int a= obj.InsertBus(textBox1.Text, textBox2.Text, textBox3.Text, textBox4.Text, textBox5.Text, textBox6.Text, checkBox1.Checked, checkBox2.Checked, checkBox3.Checked);
            if (a == 0)
                MessageBox.Show("Bus Is Already Parked");
            else
            {
